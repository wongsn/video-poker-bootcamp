(function () {
  ...
  (wrapJQuery = function () {
    let property; let _i; let _len; let _ref; let
      _results;
    if (_jQueryWrapped) {
      return;
    }
  ...
  Odometer = (function () {
    ...
    Odometer.prototype.resetFormat = function () {
      let format; let fractional; let parsed; let precision; let radix; let repeating; let _ref; let
        _ref1;
    ...
    Odometer.prototype.render = function (value) {
      let classes; let cls; let digit; let match; let newClasses; let theme; let wholePart; let _i; let _j; let _len; let _len1; let
        _ref;
      if (value == null) {
        value = this.value;
      }
    ...
    Odometer.prototype.addDigit = function (value, repeating) {
      let chr; let digit; let resetted; let
        _ref;
      if (repeating == null) {
        repeating = true;
      }
    ...
    Odometer.prototype.getDigitCount = function () {
      let i; let max; let value; let values; let _i; let
        _len;
    ...
    Odometer.prototype.getFractionalDigitCount = function () {
      let i; let parser; let parts; let value; let values; let _i; let
        _len;
      values = arguments.length >= 1 ? __slice.call(arguments, 0) : [];
      parser = /^\-?\d*\.(\d*?)0*$/;
      for (i = _i = 0, _len = values.length; _i < _len; i = ++_i) {
    ...
    Odometer.prototype.animateSlide = function (newValue) {
      let boosted; let cur; let diff; let digitCount; let digits; let dist; let end; let fractionalCount; let frame; let frames; let i; let incr; let j; let mark; let numEl; let oldValue; let start; let _base; let _i; let _j; let _k; let _l; let _len; let _len1; let _len2; let _m; let _ref; let
        _results;
      oldValue = this.value;
      fractionalCount = this.getFractionalDigitCount(oldValue, newValue);
      if (fractionalCount) {
        newValue *= Math.pow(10, fractionalCount);
  ...
  setTimeout(() => {
    let k; let v; let _base; let _ref1; let
      _results;
  ...
  Odometer.init = function () {
    let el; let elements; let _i; let _len; let _ref1; let
      _results;
